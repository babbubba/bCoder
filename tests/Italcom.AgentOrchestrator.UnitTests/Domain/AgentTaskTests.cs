...
using TaskStatus = Italcom.AgentOrchestrator.Domain.TaskStatus;
...
namespace Italcom.AgentOrchestrator.UnitTests.Domain
{
    public sealed class AgentTaskTests
    {
        ...
        private static AgentTask CreateNotStarted() => new(
            Guid.NewGuid(), WorkRequestId, "test task", [],
        ...
        [Fact]
        public void Constructor_throws_on_null_description() => Assert.Throws<ArgumentNullException>(() => new AgentTask(
                                                                             Guid.NewGuid(), WorkRequestId, null!, []));

        [Fact]
        public void Constructor_throws_on_null_dependencyIds() => Assert.Throws<ArgumentNullException>(() => new AgentTask(
