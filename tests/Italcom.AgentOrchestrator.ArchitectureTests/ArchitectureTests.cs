...
namespace Italcom.AgentOrchestrator.ArchitectureTests
{
    public sealed class ArchitectureTests
    {
        ...
        // _infrastructureAssembly and _agentRuntimeAssembly available when tests are added
        ...
        private static IEnumerable<string> GetReferencedAssemblyNames(Assembly asm) => asm.GetReferencedAssemblies()
                .Select(r => r.Name)
