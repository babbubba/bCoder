...
Implementare adapter OpenRouter senza esporre la chiave agli agenti.
...
- [ ] Header e endpoint configurabili
- [ ] Usage e modello effettivo registrati
- [ ] Retry HTTP non duplica chiamate non idempotenti
...
```text
/implement-task taskPath=agentic/tasks/TASK-011-openrouter-provider.md
```

In alternativa:

```text
Implementa esclusivamente TASK-011 leggendo agentic/AGENTS.md e agentic/tasks/TASK-011-openrouter-provider.md.
...
```text
/review-task taskPath=agentic/tasks/TASK-011-openrouter-provider.md
```
