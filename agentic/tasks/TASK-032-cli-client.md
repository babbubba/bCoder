...
| Dipendenze | [031](TASK-031-rest-and-sse-api.md) |
| Rischio | Basso/Medio |

## Obiettivo

CLI per creare richiesta, seguire eventi, approvare e scaricare report.
...
```text
/implement-task taskPath=agentic/tasks/TASK-032-cli-client.md
```

In alternativa:

```text
Implementa esclusivamente TASK-032 leggendo agentic/AGENTS.md e agentic/tasks/TASK-032-cli-client.md.
...
```text
/review-task taskPath=agentic/tasks/TASK-032-cli-client.md
```
