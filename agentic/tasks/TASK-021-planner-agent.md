...
| Dipendenze | [020](TASK-020-microsoft-agent-framework-integration.md) |
| Rischio | Medio/Alto |

## Obiettivo

Creare planner locale che produce piano/task strutturati senza modificare codice.
...
- [ ] Context recommendation 32K/64K
...
```text
/implement-task taskPath=agentic/tasks/TASK-021-planner-agent.md
```

In alternativa:

```text
Implementa esclusivamente TASK-021 leggendo agentic/AGENTS.md e agentic/tasks/TASK-021-planner-agent.md.
...
```text
/review-task taskPath=agentic/tasks/TASK-021-planner-agent.md
```
