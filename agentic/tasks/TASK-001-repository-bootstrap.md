...
Creare metadati, directory iniziali, editorconfig, gitignore e verificare che le istruzioni agentiche siano rilevate.
...
- [ ] Struttura conforme al pacchetto bootstrap
- [ ] Nessun file temporaneo o segreto tracciato
- [ ] Script init funzionanti su shell o PowerShell

## Verifiche e test

- [ ] Verifica `git status` pulito dopo commit iniziale
- [ ] Verifica link Markdown principali
...
```text
Implementa esclusivamente TASK-001 leggendo agentic/AGENTS.md e agentic/tasks/TASK-001-repository-bootstrap.md.
...
```text
/review-task taskPath=agentic/tasks/TASK-001-repository-bootstrap.md
```
