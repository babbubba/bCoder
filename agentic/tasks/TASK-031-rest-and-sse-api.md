...
| Dipendenze | [008](TASK-008-api-contracts-and-error-model.md), [030](TASK-030-checkpointed-orchestration-workflow.md) |
| Rischio | Basso/Medio |

## Obiettivo

Implementare endpoint MVP e streaming eventi.
...
- [ ] Authorization hook predisposto
...
```text
/implement-task taskPath=agentic/tasks/TASK-031-rest-and-sse-api.md
```

In alternativa:

```text
Implementa esclusivamente TASK-031 leggendo agentic/AGENTS.md e agentic/tasks/TASK-031-rest-and-sse-api.md.
...
```text
/review-task taskPath=agentic/tasks/TASK-031-rest-and-sse-api.md
```
