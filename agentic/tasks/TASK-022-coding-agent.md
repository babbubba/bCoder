...
| Dipendenze | [020](TASK-020-microsoft-agent-framework-integration.md), [021](TASK-021-planner-agent.md) |
| Rischio | Medio/Alto |

## Obiettivo

Creare coder che lavora su un solo task e usa tools concessi.
...
```text
/implement-task taskPath=agentic/tasks/TASK-022-coding-agent.md
```

In alternativa:

```text
Implementa esclusivamente TASK-022 leggendo agentic/AGENTS.md e agentic/tasks/TASK-022-coding-agent.md.
...
```text
/review-task taskPath=agentic/tasks/TASK-022-coding-agent.md
```
