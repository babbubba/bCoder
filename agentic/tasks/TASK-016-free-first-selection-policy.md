# TASK-016 — Free-first selection policy
...
| Dipendenze | [015](TASK-015-deterministic-routing-engine.md) |
| Rischio | Medio/Alto |

## Obiettivo

Applicare ordine local, specific free, free router, economy, frontier.
...
- [ ] Specific free preferito a router casuale quando disponibile
- [ ] Free router solo low-risk
- [ ] No paid senza policy

## Verifiche e test

- [ ] Scenario matrix tests
- [ ] Availability/rate-limit cases
...
```text
/implement-task taskPath=agentic/tasks/TASK-016-free-first-selection-policy.md
```

In alternativa:

```text
Implementa esclusivamente TASK-016 leggendo agentic/AGENTS.md e agentic/tasks/TASK-016-free-first-selection-policy.md.
...
```text
/review-task taskPath=agentic/tasks/TASK-016-free-first-selection-policy.md
```
