# TASK-013 — Capability and pricing normalization
...
| Dipendenze | [012](TASK-012-openrouter-model-catalog-sync.md) |
| Rischio | Medio/Alto |

## Obiettivo

Costruire capability matrix e ranking preliminare indipendente dal provider.
...
- [ ] Context/tool/structured/reasoning normalizzati
- [ ] Prezzo comparabile
- [ ] Unknown values gestiti conservativamente

## Verifiche e test

- [ ] Ranking unit tests
- [ ] Incomplete metadata tests
...
```text
/implement-task taskPath=agentic/tasks/TASK-013-capability-and-pricing-normalization.md
```

In alternativa:

```text
Implementa esclusivamente TASK-013 leggendo agentic/AGENTS.md e agentic/tasks/TASK-013-capability-and-pricing-normalization.md.
...
```text
/review-task taskPath=agentic/tasks/TASK-013-capability-and-pricing-normalization.md
```
