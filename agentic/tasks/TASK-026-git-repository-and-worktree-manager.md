# TASK-026 — Git repository and worktree manager
...
| Dipendenze | [005](TASK-005-domain-model-and-invariants.md), [006](TASK-006-postgresql-persistence-and-migrations.md) |
| Rischio | Medio/Alto |

## Obiettivo

Gestire clone/repository esistente, branch e worktree per task.
...
```text
/implement-task taskPath=agentic/tasks/TASK-026-git-repository-and-worktree-manager.md
```

In alternativa:

```text
Implementa esclusivamente TASK-026 leggendo agentic/AGENTS.md e agentic/tasks/TASK-026-git-repository-and-worktree-manager.md.
...
```text
/review-task taskPath=agentic/tasks/TASK-026-git-repository-and-worktree-manager.md
```
