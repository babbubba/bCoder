# TASK-006 — PostgreSQL persistence and migrations
...
| Dipendenze | [004](TASK-004-configuration-and-secrets.md), [005](TASK-005-domain-model-and-invariants.md) |
| Rischio | Medio/Alto |

## Obiettivo

Persistenza EF Core o adapter equivalente per richieste, task, tentativi, approval, costi e checkpoint.
...
- [ ] Migrazione iniziale
- [ ] Concurrency token dove necessario
- [ ] Repository/use case cancellabili
...
```text
/implement-task taskPath=agentic/tasks/TASK-006-postgresql-persistence-and-migrations.md
```

In alternativa:

```text
Implementa esclusivamente TASK-006 leggendo agentic/AGENTS.md e agentic/tasks/TASK-006-postgresql-persistence-and-migrations.md.
...
```text
/review-task taskPath=agentic/tasks/TASK-006-postgresql-persistence-and-migrations.md
```
