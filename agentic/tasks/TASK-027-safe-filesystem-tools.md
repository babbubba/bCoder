# TASK-027 — Safe filesystem tools
...
| Dipendenze | [026](TASK-026-git-repository-and-worktree-manager.md), [017](TASK-017-privacy-and-data-egress-gate.md) |
| Rischio | Basso/Medio |

## Obiettivo

Implementare read/search/write/patch confinati alla worktree.
...
- [ ] Symlink escape bloccato
- [ ] Limiti dimensione/output
...
```text
/implement-task taskPath=agentic/tasks/TASK-027-safe-filesystem-tools.md
```

In alternativa:

```text
Implementa esclusivamente TASK-027 leggendo agentic/AGENTS.md e agentic/tasks/TASK-027-safe-filesystem-tools.md.
...
```text
/review-task taskPath=agentic/tasks/TASK-027-safe-filesystem-tools.md
```
