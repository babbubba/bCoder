...
| Dipendenze | [020](TASK-020-microsoft-agent-framework-integration.md), [022](TASK-022-coding-agent.md) |
| Rischio | Basso/Medio |

## Obiettivo

Creare reviewer indipendente con finding e decisione tipizzata.
...
- [ ] Nuova sessione
- [ ] Severity e file/line quando possibile
- [ ] Non approva build fallita
...
```text
/implement-task taskPath=agentic/tasks/TASK-023-reviewer-agent.md
```

In alternativa:

```text
Implementa esclusivamente TASK-023 leggendo agentic/AGENTS.md e agentic/tasks/TASK-023-reviewer-agent.md.
...
```text
/review-task taskPath=agentic/tasks/TASK-023-reviewer-agent.md
```
