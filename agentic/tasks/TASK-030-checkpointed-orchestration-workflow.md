# TASK-030 — Checkpointed orchestration workflow
...
| Dipendenze | [019](TASK-019-retry-evaluation-and-escalation.md), [025](TASK-025-agent-as-tool-delegation.md), [026](TASK-026-git-repository-and-worktree-manager.md), [029](TASK-029-build-and-test-adapters.md) |
| Rischio | Medio/Alto |

## Obiettivo

Implementare workflow plan-route-execute-validate-review con checkpoint/resume.
...
```text
/implement-task taskPath=agentic/tasks/TASK-030-checkpointed-orchestration-workflow.md
```

In alternativa:

```text
Implementa esclusivamente TASK-030 leggendo agentic/AGENTS.md e agentic/tasks/TASK-030-checkpointed-orchestration-workflow.md.
...
```text
/review-task taskPath=agentic/tasks/TASK-030-checkpointed-orchestration-workflow.md
```
