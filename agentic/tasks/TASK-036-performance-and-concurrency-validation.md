# TASK-036 — Performance and concurrency validation
...
| Dipendenze | [030](TASK-030-checkpointed-orchestration-workflow.md), [034](TASK-034-integration-and-end-to-end-harness.md) |
| Rischio | Medio/Alto |

## Obiettivo

Misurare concorrenza, code, timeout e impatto del contesto.
...
- [ ] Backpressure definita

## Verifiche e test

- [ ] Load test controllato
...
```text
/implement-task taskPath=agentic/tasks/TASK-036-performance-and-concurrency-validation.md
```

In alternativa:

```text
Implementa esclusivamente TASK-036 leggendo agentic/AGENTS.md e agentic/tasks/TASK-036-performance-and-concurrency-validation.md.
...
```text
/review-task taskPath=agentic/tasks/TASK-036-performance-and-concurrency-validation.md
```
