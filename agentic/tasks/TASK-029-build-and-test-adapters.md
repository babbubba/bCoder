# TASK-029 — Build and test adapters
...
| Dipendenze | [028](TASK-028-safe-process-runner.md) |
| Rischio | Basso/Medio |

## Obiettivo

Adapter per dotnet e Node/Angular con output normalizzato.
...
- [ ] Restore/build/test separati
- [ ] Exit code e artifact log
...
```text
/implement-task taskPath=agentic/tasks/TASK-029-build-and-test-adapters.md
```

In alternativa:

```text
Implementa esclusivamente TASK-029 leggendo agentic/AGENTS.md e agentic/tasks/TASK-029-build-and-test-adapters.md.
...
```text
/review-task taskPath=agentic/tasks/TASK-029-build-and-test-adapters.md
```
