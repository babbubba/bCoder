# TASK-017 — Privacy and data-egress gate
...
| Dipendenze | [005](TASK-005-domain-model-and-invariants.md), [015](TASK-015-deterministic-routing-engine.md) |
| Rischio | Medio/Alto |

## Obiettivo

Classificare contesto, redigere e bloccare invii non consentiti.
...
- [ ] Default Internal
- [ ] Restricted sempre bloccato
- [ ] Decisione auditabile
- [ ] Redaction separata dalla classificazione

## Verifiche e test

- [ ] Leakage tests
- [ ] Pattern sensitive tests
- [ ] Approval exception tests
...
```text
/implement-task taskPath=agentic/tasks/TASK-017-privacy-and-data-egress-gate.md
```

In alternativa:

```text
Implementa esclusivamente TASK-017 leggendo agentic/AGENTS.md e agentic/tasks/TASK-017-privacy-and-data-egress-gate.md.
...
```text
/review-task taskPath=agentic/tasks/TASK-017-privacy-and-data-egress-gate.md
```
