# Context package 012 — TASK-012 — OpenRouter model catalog sync

| Campo | Valore |
|---|---|
| Budget operativo | **64K** |
| Modello in modalità autonoma | Eredita **Long 64K** dal Project Runner |
| Task | `agentic/tasks/TASK-012-openrouter-model-catalog-sync.md` |

## Documenti autorizzati

- `agentic/governance/MODEL_ROUTING.md` — sezioni: `Regole free-first`, `Output della selezione`.
- `agentic/governance/SECURITY.md` — sezioni: `Provider esterni`.

Leggere solo le sezioni indicate, usando ricerca per heading quando possibile.

## Aree di codice autorizzate

- OpenRouter provider, catalog DTOs, cache, tests.
...
- Non leggere Agent Framework o planner.
