# Context package 032 — TASK-032 — CLI client

| Campo | Valore |
|---|---|
| Budget operativo | **32K** |
| Modello in modalità autonoma | Eredita **Long 64K** dal Project Runner |
| Task | `agentic/tasks/TASK-032-cli-client.md` |

## Documenti autorizzati

- `agentic/architecture/API_CONTRACT.md` — sezioni: `endpoint e SSE pertinenti`.
- `agentic/architecture/ARCHITECTURE.md` — sezioni: `CLI`.

Leggere solo le sezioni indicate, usando ricerca per heading quando possibile.

## Aree di codice autorizzate

- API client, CLI project, CLI tests.
