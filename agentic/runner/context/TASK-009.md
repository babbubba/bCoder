# Context package 009 — TASK-009 — Common model provider abstraction

| Campo | Valore |
|---|---|
| Budget operativo | **32K** |
| Modello in modalità autonoma | Eredita **Long 64K** dal Project Runner |
| Task | `agentic/tasks/TASK-009-common-model-provider-abstraction.md` |

## Documenti autorizzati

- `agentic/governance/MODEL_ROUTING.md` — sezioni: `Output della selezione`.
...
- provider abstractions e unit tests.
...
- Non leggere provider concreti o OpenRouter docs.
