# Context package 006 — TASK-006 — PostgreSQL persistence and migrations

| Campo | Valore |
|---|---|
| Budget operativo | **64K** |
| Modello in modalità autonoma | Eredita **Long 64K** dal Project Runner |
| Task | `agentic/tasks/TASK-006-postgresql-persistence-and-migrations.md` |

## Documenti autorizzati

- `agentic/architecture/DOMAIN_MODEL.md` — sezioni: `tutte le sezioni`.
- `agentic/architecture/ARCHITECTURE.md` — sezioni: `Infrastructure`, `Principi`.
- `agentic/governance/SECURITY.md` — sezioni: `Segreti`.

Leggere solo le sezioni indicate, usando ricerca per heading quando possibile.

## Aree di codice autorizzate

- persistence project, migrations, integration tests.
...
- Non leggere agent runtime o routing.
